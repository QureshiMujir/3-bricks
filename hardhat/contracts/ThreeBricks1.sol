...
contract ThreeBricks1 is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter public _tokenIdCounter;

    constructor() ERC721("ThreeBricks1", "TBRS") {}
    ...
    function completePaymentAndEsrow(uint256 tokenId) public payable {
        ...
        address payable sellerPayableAddress = tokenIdToSellerPayableAddress[
            tokenId
        ];
